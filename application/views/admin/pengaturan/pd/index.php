  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1>Data Perangkat Daerah Pemungut Retribusi</h1>
          </div>
          <div class="col-sm-4">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Berikut merupakan data perangkat daerah berkaitan dengan retribusi daerah di Kabupaten Garut</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
